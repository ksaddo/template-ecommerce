    ...
    <section className="grid gap-4 md:gap-8 p-[clamp(1rem,4vw,8rem)] md:grid-cols-2 md:min-h-[700px] 2xl:min-h-[900px]">
      ...
      <div className="relative h-[300px] md:h-[700px] 2xl:h-[900px] overflow-hidden group">
        ...
        <Image
          ...
          className="object-cover transition-transform duration-1000 ease-in-out group-hover:scale-110 blur-[2px] focus:blur-none md:blur-none"
          priority
        />
      ...
      <div className="grid gap-4 md:gap-8 text-white">
        ...
        <div className="relative h-[300px] md:h-auto overflow-hidden border group">
          ...
          <Image
            ...
            fill
            sizes="(max-width: 768px) 100vw, 50vw"
            className="object-contain transition-transform duration-1000 ease-in-out group-hover:scale-110 blur-[2px] focus:blur-none md:blur-none"
            priority
          />
